...
const supportApi = [
  ...
  },
  {
    id: 2,
    text:
      "Absolutely safe to use as we never ask for your account password or any app permissions"
  },
  {
    id: 3,
    ...
    <div className="App__container">
      ...
      >
        <section className="social-block">
          <div className="social-block__wrap">
            <aside className="main-info">
              ...
              <p className="social-block__text">
                Traffup is a free Instagram promotion service that helps you
                increase your Instagram followers and likes on your posts
                quickly and easily. Showcase your profile, photos or videos in
                front of thousands of other users and get more followers and
                likes instantly and free of cost.
              </p>
              <p className="social-block__text">
                You do not have to complete any awkward surveys or share your
                account password to get followers and likes. Traffup is the No.
                1 social exchange network providing instant and free followers
                and likes to users all over the world. Simply sign up and enter
                your Instagram username to get started - it takes less than a
                minute!
              </p>
            </aside>
          ...
          <h1 className="social-block__text">
            Boost your Instagram profile and enjoy the benefits of increased
            traffic and popularity in just 3 steps.{" "}
          </h1>
