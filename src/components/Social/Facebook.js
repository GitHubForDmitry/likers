...
const FacebookApi = [
    {
        ...
        textPrimary:
            "and add your Facebook pages and posts.",
            ...
            >
                <section className="social-block">
                    ...
                    <p className="social-block__text">
                        Drive awareness and traffic using our free Facebook promotion service developed to help you get likes on Facebook pages and posts from people all over the world. </p>
                    <p className="social-block__text">
                        Promote your pages and posts in front of thousands of real users and get free Facebook likes within minutes.</p>
                    <p className="social-block__text--works">Get more likes in 3 steps. Here's how it works:</p>
                ...
                <aside className="support-info">
                    <ul className="support-info__list">
                        <li className="support-info__title">WHY LIKERS FOR FACEBOOK?</li>
                        {supportApi.map(s => (
